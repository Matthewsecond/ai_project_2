...
- company_summary      : AI summary of a company's hiring profile (Company tab; prose)

The LLM calls (briefing, filter suggestion, elaboration, session chats, company summary) use
Structured Outputs; the PDF builders are pure reportlab. Public API — import from the package:
