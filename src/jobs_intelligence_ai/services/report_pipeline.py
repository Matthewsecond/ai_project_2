...
def _build_market(story, ST, cand_jobs, page_meta, foot_left):
    # The opportunity map uses hardcoded Austrian Bundesland geometry; skip the
    # whole market/map section for countries without map geometry (e.g. SK).
    if not config.HAS_MAP:
        return
